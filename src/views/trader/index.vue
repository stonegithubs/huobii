  ...
  <div class="trader">
    <div class="wrapper hidden-xs-only">
      <div class="base-info">
        ...
        <div class="down-info">
          <div class="register-time">注册时间： {{ registerTime }}</div>
          <div class="auth-info">
      ...
      <div class="user-ad">
        <div class="t-sell">
          ...
          <order-list :merchantList="merchantList" :avatarShow="false"></order-list>
        </div>
        <!-- <div class="t-buy">
      ...
      <div class="base-info">
        ...
        <!-- <div class="m-credit-info">
          <div class="baseInfo-in">
            <p>
              <span class="text-box">商家保证金</span>
              <span>{{ ensuranceMoney }} {{ ensuranceCoin }}</span>
            </p>
            <p>
              <span class="text-box">30日完成率</span>
              <span>{{ recentDealRate }}%</span>
            </p>
            <p>
              <span class="text-box">总成交</span>
              <span>{{ orderTotal }}次</span>
            </p>
            <p>
              <span class="text-box">30日成交</span>
              <span>{{ recentOrder }}次</span>
            </p>
            <p>
              <span class="text-box">平均放行</span>
              <span>{{ averageDealTime }}分钟</span>
            </p>
          </div>
          <div class="verify-info">
            <div :class="{ 'done': verifyList.email}" class="auth-item">邮箱认证
              <i class="el-icon-success"/>
            </div>
            <div :class="{ 'done': verifyList.phone}" class="auth-item">手机认证
              <i class="el-icon-success"/>
            </div>
            <div :class="{ 'done': verifyList.true_name}" class="auth-item">实名认证
              <i class="el-icon-success"/>
            </div>
            <div :class="{ 'done': verifyList.adVerify}" class="auth-item">高级认证
              <i class="el-icon-success"/>
            </div>
          </div>
    </div>-->
        ...
        <div>
          ...
          <div v-for="item in sellList" class="ad-list">
            <div class="trader-logo">
              <div>
                <i
                  :class="'iconfont'+' '+'icon-'+ item.coinType"
...
import { userOrders } from "@/api/trade";
...
export default {
  ...
  data() {
    return {
      ...
      //     coinType: "BTC",
      //     number: 15.87653,
      //     limit: { min: 300, max: 1789 },
      //     price: 21334,
      //     priceType: "CNY",
      //     payment_list: ["alipay", "wechat", "bank"]
      //   },
      //   {
      //     id: 91,
      //     coinType: "USDT",
      //     number: 15.87653,
      //     limit: { min: 301230, max: 125789 },
      //     price: 21334,
      //     priceType: "CNY",
      //     payment_list: ["wechat", "bank"]
      //   },
      //   {
      //     id: 90,
      //     coinType: "EOS",
      //     number: 15.87653,
      //     limit: { min: 300, max: 621789 },
      //     price: 21334,
      //     priceType: "CNY",
      //     payment_list: ["alipay", "wechat"]
      //   },
      //   {
      //     id: 11,
      //     coinType: "HT",
      //     number: 15.87653,
      //     limit: { min: 300, max: 1265789 },
      //     price: 21334,
      //     priceType: "CNY",
      //     payment_list: ["alipay", "bank"]
      //   },
      //   {
      //     id: 99,
      //     coinType: "BTC",
      //     number: 15.87653,
      //     limit: { min: 12000, max: 65789 },
      //     price: 21334,
      //     priceType: "CNY",
      //     payment_list: ["alipay", "wechat", "bank"]
      //   }
  ...
  created() {
    ...
    // if(userId)
    userOrders(0, 10, userId)
      .then(res => {
        if (res && res.code === "200") {
          this.userInfo = res.content
          this.merchantList = res.content.records;
        }
      })
      .catch(_ => {});
  },
