  ...
  <div class="trade-assets">
    <el-card>
      <div slot="header" class="clearfix">
        <span class="font16">钱包明细</span>
        <el-button style="float: right; padding: 3px 0" type="text">
          <router-link class="to-withdraw" :to="{ name: 'withdraw_address'}" style="color: #638bd4!important;">提币地址管理</router-link>
        </el-button>
      </div>
    ...
    <el-dialog :title="'充值'+ this.currentCoinName" :modal-append-to-body="false" :visible.sync="transferDiaVisible" width="50%">
      <transferDialog :coinInfo="currentCoin"></transferDialog>
    </el-dialog>
    <el-dialog title="资产互转" :modal-append-to-body="false" :visible.sync="depositDiaVisible" :before-close="handledepositClose" width="50%">
