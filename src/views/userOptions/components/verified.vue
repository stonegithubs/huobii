<template>
  <el-card class="box-card verify">
    ...
    <el-form v-if="auditFlag === 2||auditFlag === null" label-position='top' label-width="80px" :model="verifyForm" ref='verifyForm'>
      ...
      <el-form-item :label="$t('userOptions.idNo')" prop="idNo" :rules="[{ required: true, message: 'this field is required', trigger: 'blur' }]">
        <el-input v-model="verifyForm.idNo"></el-input>
      </el-form-item>
      <el-form-item :label="$t('userOptions.type')" prop="type" :rules="[{ required: true, message: 'this field is required', trigger: 'blur' }]">
